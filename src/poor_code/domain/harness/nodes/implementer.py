...
_SYSTEM = (
    ...
    "stop calling tools.\n"
    "4b. When STEPS are listed the harness drives them test-first and gates each one: "
    "a test must be confirmed to FAIL before its implementation, and each step must pass "
    "its gate before the next. Write the code for the step you are given; do not jump "
    "ahead.\n"
