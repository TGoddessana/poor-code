...
_SYSTEM = (
    ...
    "RULES:\n"
    "1. State the EXACT expected behaviour/value, not a vague goal — e.g. 'for the 2x2 grid "
    "[[0,1],[2,3]] the output is the 6x6 grid <...>', not 'transforms the grid correctly'.\n"
    "2. Describe BEHAVIOUR an observer can check by running it (the file content produced, "
    "the HTTP response, the exit status), not that some string appears somewhere.\n"
